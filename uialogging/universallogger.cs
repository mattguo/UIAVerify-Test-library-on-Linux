...
namespace Microsoft.Test.UIAutomation.Logging
{
    ...
    public class LogTypes
    {
        ...
        public const string DefaultLogger = XmlLogger;

        internal const string XMLLoggerDll = "UIALoggerXML.dll";
    }
    ...
    public class GenericLogger : ILoggedComponent
    {
        ...
        virtual protected void LogStartTest(StartTestInfo startTestInfo)
        {
            ...
            LogComment("".PadLeft(80, '=') + "\n" + startTestInfo.ToString() + "\n" + "".PadLeft(80, '='), ConsoleColor.Green);
        }
    ...
    public class Logger
    {
        ...
        /// ---------------------------------------------------------------
        /// <summary>
        /// Some frameworks will kill a process if it
        ...
        /// -------------------------------------------------------------------
        /// <summary>
        /// Loads a logger DLL binary that impements UIALogging interface.
        /// </summary>
