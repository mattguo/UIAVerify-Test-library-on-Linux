...
namespace Microsoft.Test.UIAutomation.Tests.Controls
{
	...
	public sealed class TextControlTests : ControlObject
    {
        ...
        public void StaticsDontHaveLabels(TestCaseAttribute testCaseAttribute)
        {
            ...
            //"Precondition: Classname is 'Static'",
            TSC_VerifyProperty(m_le.Current.ClassName.ToLower(), "static", true, "classname", CheckType.IncorrectElementConfiguration);

            //"Verify: LabeledBy == null",
            TSC_VerifyProperty(m_le.Current.LabeledBy, null, "LabeledBy", CheckType.Verification);
        ...
        [TestCaseAttribute("IsTextPatternAvailableProperty.1",
           TestSummary = "Depends on framework whether TextPattern will be supported on text elements.  For WPF elements TextPattern will be supported.  For legacy text elements it will not be able to be supported.  Any new framework supporting UIAutomation must expose TextPattern for text elements.",
            TestCaseType = TestCaseType.Generic,
