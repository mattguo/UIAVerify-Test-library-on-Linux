...
namespace Microsoft.Test.UIAutomation.Tests.Patterns
{
    ...
    public sealed class SelectionItemTests : SelectionItemPatternWrapper
    {
        ...
        public void TestSelect27(TestCaseAttribute testCase)
        {
            ...
            // Should be false on the list box.  There may be other scenarios where it is otherwise.  If we find them, bug it.
        ...
        public void TestSelect23(TestCaseAttribute testCase)
        {
            ...
            this.TestDriverAddToSelection3(false, false);
        }
        ...
        public void TestSelect29(TestCaseAttribute testCase)
        {
            ...
            this.HeaderComment(testCase);
            this.TestDriverAddToSelection3(true, false);
        }
        ...
        private void TestDriverAddToSelection1(bool isSelectionRequired, bool canSelectMultiple, Type exceptionType)
        {
            ...
            // "Step: Call AddToSelection on the same element and verify that InvalidOperationException is thrown",
            // This happens on ("<Control><E><N>Notepad</N><C>ControlType.Window</C><E><N>Combo(1005)</N><C>ControlType.ComboBox</C><I>1005</I><E><C>ControlType.List</C><I>ListBox</I><E><N>String 5</N><C>ControlType.ListItem</C></E></E></E></E></Control>")
            // TreeItem does not do this
            // ListView does not do this...
            // Believe it does not on another control.  Verify this if the bug comes through again.
