...
namespace InternalHelper.Tests.Patterns
{
    ...
    public class ScrollPatternWrapper : PatternObject
    {
        ...
        internal bool pattern_getHorizontallyScrollable { get { return m_pattern.Current.HorizontallyScrollable; } }
        internal double pattern_getHorizontalScrollPercent { get { return m_pattern.Current.HorizontalScrollPercent; } }
        internal double pattern_getHorizontalViewSize { get { return m_pattern.Current.HorizontalViewSize; } }
        internal double pattern_getVerticalViewSize { get { return m_pattern.Current.VerticalViewSize; } }
        internal bool pattern_getVerticallyScrollable { get { return m_pattern.Current.VerticallyScrollable; } }
        internal double pattern_getVerticalScrollPercent { get { return m_pattern.Current.VerticalScrollPercent; } }
        ...
        internal void pattern_SetScrollPercent(double horizontalPercent, double verticalPercent, Type expectedException, CheckType checkType)
        {
            ...
            try
            {
                ...
                m_pattern.SetScrollPercent(horizontalPercent, verticalPercent);
                Thread.Sleep(1);
...
namespace Microsoft.Test.UIAutomation.Tests.Patterns
{
    ...
    public sealed class ScrollTests : ScrollPatternWrapper
    {
        ...
        /// <summary>Defines which UI Automation Pattern this tests</summary>
        ...
        new void HeaderComment(TestCaseAttribute testCaseAttribute)
        {
            if (m_le.Current.IsOffscreen)
                ThrowMe(CheckType.IncorrectElementConfiguration, "Element is not visible so cannot run the tests.");
        ...
        static System.Threading.ManualResetEvent _notifiedEvent = new System.Threading.ManualResetEvent(false);
            ...
            )
        {
            ...
            //"3 Step: Add a property changed listener for HorizontalScrollPercentProperty",
            ...
            //"4 Step: Add a property changed listener for VerticalScrollPercentProperty",
            ...
            //"9 Wait and eat 2 possible events before we actually start the test
            TSC_WaitForEvents(2);

            //"10 Removing all events fired");
            TS_RemoveAllEventsFired();

            Comment("".PadRight(50, '-'));

            //"11 Call SetScrollPercent (NoScroll,0) and verify that method returns true",
            TSC_SetScrollPercent(newHPercent, newVPercent, exceptionExpected, CheckType.Verification);

            // 12 Now wait for 2 events tested events",
            TSC_WaitForEvents(2);

            //"13 Verify that HorizontalPercent = expectedHPercent",
            TSC_VerifyScrollPercent(expectedHPercent, ScrollDirection.Horizontal, CheckType.Verification);

            //"14 Verify that VerticalPercent = expectedVPercent",
            TSC_VerifyScrollPercent(expectedVPercent, ScrollDirection.Vertical, CheckType.Verification);

            //"15 Verify that the firing of the event listener HorizontalScrollPercentProperty is Undetermined",
            ...
            //"16 Verify that the firing of the event listener VerticalScrollPercentProperty is false",
        ...
        [TestCaseAttribute("SetScrollPercent.S.1.1",
            ...
            Description = new string[]
			{
                ...
                "Step: Verify that it was set correctly",
                "Wait and eat 2 possible events before we actually start the test",
                "Removing all events fired",
        ...
        [TestCaseAttribute("SetScrollPercent.S.1.6",
            ...
            Status = TestStatus.Works, Author = "Microsoft Corp.",
           TestCaseType = TestCaseType.Events, EventTested = "AutomationPropertyChangedEventHandler(ScrollPattern.HorizontalScrollPercentProperty)/AutomationPropertyChangedEventHandler(ScrollPattern.VerticalScrollPercentProperty)",
           Description = new string[]
		{
			"Precondition: Verify that HorizontalScrollable = false",
			...
			"Verify that HorizontalPercent = NoScroll", 
            "Verify that VerticalPercent = 0", 
			"Verify that the firing of the event listener HorizonatcalScrollPercentProperty is undetermined", /* TODO$: Bug workaround, should be false */
            "Verify that the firing of the event listener VerticalScrollPercentProperty is undetermined", /* TODO$: Bug workaround, should be false */
		 }
             )]
            ...
            Description = new string[]
		{
            ...
            "Removing all events fired",
            "Call SetScrollPercent (NoScroll,V) and verify that method returns true",
            "Now wait for 2 events tested events",
            "Verify that HorizontalPercent = NoScroll",
            "Verify that VerticalPercent = NoChange",
            "Verify that the firing of the event listener HorizontalScrollPercentProperty is Undetermined",
            "Verify that the firing of the event listener VerticalScrollPercentProperty is true",
		 }
             )]
        ...
        {
            // Don't do any tests, element is not visible
            if (m_le.Current.IsOffscreen)
            {
                _validHPositions = new ArrayList();
                _validVPositions = new ArrayList();
                return;
            }
        ...
        [TestCaseAttribute("SetScrollPercent.S.1.26",
            ...
            EventTested = "AutomationPropertyChangedEventHandler(ScrollPattern.HorizontalScrollPercentProperty)/AutomationPropertyChangedEventHandler(ScrollPattern.VerticalScrollPercentProperty)",
            Status = TestStatus.Works,
            Author = "Microsoft Corp.",
            Description = new string[]
		{
            ...
            Description = new string[]
		{
			...
			"Verify that VerticalPercent = NoScroll", 
			"Verify that the firing of the event listener HorizontalScrollPercentProperty is undetermined",    /* changed for 1023, 1042 */
			"Verify that the firing of the event listener VerticalScrollPercentProperty is false",      /* changed for 1023 */
		 }
             )]
        public void TestSetScrollPercent127(TestCaseAttribute testCaseAttribue)
        {
            ...
            this.TestC_SetScrollPercent(HScrollable, VScrollable, preH, _NOSCROLL, preH, _NOSCROLL, preH, _NOSCROLL, EventFired.Undetermined, EventFired.False, null);
        }
        ...
        [TestCaseAttribute("SetScrollPercent.S.1.36",
        ...
        [TestCaseAttribute("SetScrollPercent.S.1.37.WithCode",
            ...
            Status = TestStatus.Works,
            TestCaseType = TestCaseType.Events, EventTested = "AutomationPropertyChangedEventHandler(ScrollPattern.HorizontalScrollPercentProperty)/AutomationPropertyChangedEventHandler(ScrollPattern.VerticalScrollPercentProperty)",
            Author = "Microsoft Corp.", Description = new string[]
		{
			"Precondition: Verify that HorizontalScrollable = true",
			"Precondition: Verify that VerticalScrollable = true",
            ...
            "Step: Add a property changed listener for HorizontalScrollPercentProperty",
            "Step: Add a property changed listener for VerticalScrollPercentProperty",
            "Step: Set HorizontalPercent = oreH",
            "Step: Verify that it was set correctly",
            "Step: Set VerticalPercent = preV",
            "Step: Verify that it was set correctly",
            "Wait and eat 2 possible events before we actually start the test",
        ...
        public void TestScrollS218(TestCaseAttribute testCaseAttribue)
        {
            Comment("AAAA");
            HeaderComment(testCaseAttribue);
        ...
        [TestCaseAttribute("HorizontallyScrollableProperty.S.6.6",
            Priority = TestPriorities.Pri0,
            Status = TestStatus.Problem, /* Heather said these are not valid 14655 */
            Author = "Microsoft Corp.",
            Description = new string[]
            {
