...
namespace Microsoft.Test.UIAutomation
{
    ...
    public sealed class TestRuns
    {
        ...
        static string[] m_Duplicate = new string[] { 
        ...
        /// UI Automation Verify should preserve existing content for controls that support
        ...
        static bool _filterOutBugs = true;

        /// -------------------------------------------------------------------
        /// <summary>Set it to false if you want the tests to report failures 
        /// for known issues./// </summary>
        /// -------------------------------------------------------------------
        public static bool FilterOutBugs
        {
            get { return TestRuns._filterOutBugs; }
        ...
        /// -------------------------------------------------------------------
        public enum ProxyVersionEnum
        {
            /// <summary>
            /// Standard managed proxies used in Vista timeframe.  Default setting for TestRuns.ProxyVersion
            /// </summary>
            Vista,
            /// <summary>
            /// Use TestRuns.UiaRegisterProviderCallback() to use this setting
            /// </summary>
            ProviderCallbackNull
        }

        /// -------------------------------------------------------------------
        /// <summary>Returns the different ways that the proxies are setup.</summary>
        /// -------------------------------------------------------------------
        static ProxyVersionEnum _proxyVersion = ProxyVersionEnum.Vista;

        /// -------------------------------------------------------------------
        /// <summary>Returns the different ways that the proxies are setup.</summary>
        /// -------------------------------------------------------------------
        public static ProxyVersionEnum ProxyVersion { get { return _proxyVersion; } }

        /// -------------------------------------------------------------------
        /// <summary>Calls UiaRegisterProviderCallback(IntPtr.Zero) which unregisters
        /// the client side providers.</summary>
        /// -------------------------------------------------------------------
        ...
        public static bool RunPatternTest(AutomationElement element, bool testEvents, bool testChildren, string testSuite, string test, object arguments, IApplicationCommands commands)
        {
            ...
            if (element != null)
            {
                ...
                {
                    UIAVerifyLogger.LogUnexpectedError(exception);
                }
            }
            return passed;
        }
