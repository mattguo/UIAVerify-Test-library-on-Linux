...
namespace Microsoft.Test.UIAutomation.Core
{
    ...
    public class TestMenu : IDisposable
    {
        ...
        public TestMenu GetFirstSubMenu()
        {
            ...
            UIAVerifyLogger.LogComment(Library.GetUISpyLook(_element) + "'s ControlViewWalker.GetFirstChild = " + Library.GetUISpyLook(element));
            return new TestMenu(element);
        }
        ...
        public TestMenu GetNextSiblingMenu()
        {
            ...
            Debug.Assert(element != null);
            UIAVerifyLogger.LogComment(_element.Current.Name + "'s ControlViewWalker.GetNextSibling = " + element.Current.Name);
            return new TestMenu(element);
        }
        ...
        void expandCollapseMenu(ExpandCollapseState desiredState)
        {
            ...
            switch (desiredState)
            {
                ...
                case ExpandCollapseState.Expanded:
                    ...
                    UIAVerifyLogger.LogComment("Expanding " + _element.Current.Name);
