...
namespace InternalHelper
{
    ...
    public class Helpers
    {
        ...
        /// <summary></summary>
        /// -------------------------------------------------------------------
        static Hashtable _tableProperties = new Hashtable();

        /// -------------------------------------------------------------------
        /// <summary></summary>
        /// -------------------------------------------------------------------
        static Hashtable _tableControlTypes = new Hashtable();

        /// -------------------------------------------------------------------
        /// <summary></summary>
        /// -------------------------------------------------------------------
        static Hashtable _tableEvents = new Hashtable();

        /// -------------------------------------------------------------------
        /// <summary></summary>
        /// -------------------------------------------------------------------
        static Hashtable _tableTextAttributes = new Hashtable();
        ...
        static public string GetResourceString(string name)
        {
            ...
            foreach (string assemblyName in names)
            {
                ...
                if (assemblyName.ToLower().IndexOf("uiaverify.resources") != -1)
                {
        ...
        static public string GetXmlPathFromAutomationElement(AutomationElement element)
        {
            ...
            // Converting the stream to a string the hard way
