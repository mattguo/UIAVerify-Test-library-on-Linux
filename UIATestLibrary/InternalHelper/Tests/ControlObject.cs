...
namespace InternalHelper.Tests
{
    ...
    public class ControlObject : TestObject
    {
        ...
        internal const string NAMESPACE = IDSStrings.IDS_NAMESPACE_UIAVERIFY + "." + IDSStrings.IDS_NAMESPACE_CONTROL;
        ...
        #endregion IUIALogicalStructureChangedEvent
        ...
        /// </summary>
        /// ---------------------------------------------------------------
        [TestCaseAttribute("ControlView.1",   //Formerly: Test Control's Control View
            Priority = TestPriorities.Pri2,
            TestCaseType = TestCaseType.Generic,
            Status = TestStatus.Works,  // issues regarding resources/culture info remain
            Author = "Microsoft Corp.",
            Description = new string[] {
                "Test the control's Control View", //Formerly: Test Control's Control View
            })]
        ...
        /// </summary>
        /// ---------------------------------------------------------------
        [TestCaseAttribute("ContentView.1",   //Formerly: Test Control's Content View
            Priority = TestPriorities.Pri2,
            TestCaseType = TestCaseType.Generic,
           Status = TestStatus.Works,  // Issues regarding resources/culture info remain
            Author = "Microsoft Corp.",
            Description = new string[] {
                "Test the control's Content View", //Formerly: Test Control's Content View
            })]
        ...
        /// </summary>
        /// ---------------------------------------------------------------
        [TestCaseAttribute("Properties.1",    //Formerly: Test Control's Properties
            Priority = TestPriorities.Pri2,
            TestCaseType = TestCaseType.Generic,
            Status = TestStatus.Works,  // Issues regarding resources/culture info remain
            Author = "Microsoft Corp.",
        ...
        /// </summary>
        /// ---------------------------------------------------------------
        [TestCaseAttribute("Patterns.1",  //Formerly: Test Control's Patterns
            Priority = TestPriorities.Pri2,
            TestCaseType = TestCaseType.Generic,
           Status = TestStatus.Works,  // Issues regarding resources/culture info remain
            Author = "Microsoft Corp.",
        ...
        private bool IsNaN(object currentValue)
        {
            ...
            ThrowMe(CheckType.Verification, "UI Automation Verify needs to handle the type(" + currentValue.GetType().ToString());
            return false;
        }
