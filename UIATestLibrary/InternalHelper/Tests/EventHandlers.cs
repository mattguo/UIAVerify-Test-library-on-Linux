...
#pragma warning suppress 6517
        ...
        internal static void Comment(string format, params object[] args)
        {
            lock (typeof(EventObject))
            {
                ...
                UIAVerifyLogger.LogComment("{0} {1}", PRETAG, String.Format(format, args));
        ...
        {
            UIAVerifyLogger.LogComment("{0} Clearing {1} items from the queue", PRETAG, _eventList.Count);
