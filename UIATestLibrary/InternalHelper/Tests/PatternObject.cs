...
namespace InternalHelper.Tests
{
    ...
    public class PatternObject : TestObject
    {
        ...
        /// <summary></summary>
        /// -------------------------------------------------------------------
        internal const string NAMESPACE = IDSStrings.IDS_NAMESPACE_UIAVERIFY + "." + IDSStrings.IDS_NAMESPACE_PATTERN;

        /// -------------------------------------------------------------------
        /// <summary></summary>
        /// -------------------------------------------------------------------
        ArrayList m_cachedPatternList = new ArrayList();

        /// -------------------------------------------------------------------
        /// <summary></summary>
        /// -------------------------------------------------------------------
        Hashtable m_SeenPatterns = new Hashtable();
        ...
        internal object GetPattern(AutomationPattern patternId, CheckType ct)
        {
            ...
            foreach (BasePattern Id in m_cachedPatternList)
            {
