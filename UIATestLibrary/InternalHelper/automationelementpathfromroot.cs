...
namespace UIATestLibrary.InternalTestHelper
{
    public class AutomationElementPathFromRoot
    {
        ...
        {
            [XmlAttribute]
            public string AutomationId, ClassName, LocalizedControlType, ControlType, Name, RuntimeId;
        ...
        public AutomationElementPathFromRoot(AutomationElement element)
        {
